        ...
        <div class="col-12">
            <div class="card create-card mb-4">
                <div class="create-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('user.sakit-izin.index')); ?>" class="btn btn-back-modern">
                ...
                <div class="form-modern">
                    ...
                    <form action="<?php echo e(route('user.sakit-izin.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-modern select-modern <?php $__errorArgs = ['id_user'];
...
unset($__errorArgs, $__bag); ?>" id="id_user" name="id_user" required>
                                            <option value="">Pilih Karyawan</option>
                                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($employee->id); ?>" <?php echo e(old('id_user') == $employee->id ? 'selected' : ''); ?>>
                                                    <?php echo e($employee->nama_pegawai); ?> - <?php echo e($employee->email); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-modern <?php $__errorArgs = ['tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-modern select-modern <?php $__errorArgs = ['keterangan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="keterangan" name="keterangan" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-modern" 
                                               value="<?php echo e(Auth::user()->cabang->nama_cabang ?? 'Belum ditentukan'); ?>" 
                                               readonly>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-modern <?php $__errorArgs = ['catatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  placeholder="Masukkan catatan tambahan (opsional)"><?php echo e(old('catatan')); ?></textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="info-card">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6><i class="fas fa-user me-2"></i><?php echo e(Auth::user()->nama_pegawai); ?></h6>
                                                    <p><i class="fas fa-briefcase me-2"></i><?php echo e(Auth::user()->jabatan->nama_jabatan ?? 'Tidak ada jabatan'); ?></p>
                                                </div>
                                                <div class="col-md-6">
                                                    <h6><i class="fas fa-envelope me-2"></i><?php echo e(Auth::user()->email); ?></h6>
                                                    <p><i class="fas fa-building me-2"></i><?php echo e(Auth::user()->cabang->nama_cabang ?? 'Belum ditentukan'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\user\sakit-izin\create.blade.php ENDPATH**/ ?>