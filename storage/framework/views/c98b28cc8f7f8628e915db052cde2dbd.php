        ...
        <div class="col-lg-8">
            ...
            <div class="card form-card mb-4">
                ...
                <div class="form-body">
                    ...
                    <form action="<?php echo e(route('user.bon.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control form-control-modern" id="jumlah" name="jumlah" 
                                               placeholder="Masukkan jumlah bon" value="<?php echo e(old('jumlah')); ?>" min="1" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-modern" id="keterangan" name="keterangan" 
                                              rows="4" placeholder="Masukkan keterangan bon..." required><?php echo e(old('keterangan')); ?></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-muted">
                            ...
                            Total: <?php echo e($bons->count()); ?> data
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <?php if($bons->count() > 0): ?>
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $bons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div class="fw-bold"><?php echo e($bon->pegawai->nama_pegawai ?? 'N/A'); ?></div>
                                                    <small class="text-muted"><?php echo e($bon->pegawai->nip ?? '-'); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-dark">
                                                <?php echo e($bon->pegawai->jabatan->nama_jabatan ?? 'N/A'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div><?php echo e($bon->tanggal->format('d/m/Y')); ?></div>
                                            <small class="text-muted"><?php echo e($bon->tanggal->format('l')); ?></small>
                                        </td>
                                        <td>
                                            <div class="fw-bold text-success">
                                                Rp <?php echo e(number_format($bon->jumlah, 0, ',', '.')); ?>

                                            </div>
                                        </td>
                                        <td>
                                            <?php if($bon->status == 'approved'): ?>
                                                <span class="badge badge-status badge-approved">
                                                    <i class="fas fa-check me-1"></i>Disetujui
                                                </span>
                                            <?php elseif($bon->status == 'pending'): ?>
                                        ...
                                        <td>
                                            <div><?php echo e($bon->creator->nama_pegawai ?? 'N/A'); ?></div>
                                            <small class="text-muted"><?php echo e($bon->created_at->format('d/m/Y H:i')); ?></small>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('user.bon.show', $bon)); ?>" 
                                                   class="btn btn-action btn-view" 
                                                   title="Lihat Detail">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <?php if($bon->status == 'pending'): ?>
                                                    <a href="<?php echo e(route('user.bon.edit', $bon)); ?>" 
                                                       class="btn btn-action btn-edit" 
                                                       title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="<?php echo e(route('user.bon.destroy', $bon)); ?>" 
                                                          method="POST" 
                                                          class="d-inline"
...
<?php echo $__env->make('layouts.user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\user\bon\index.blade.php ENDPATH**/ ?>