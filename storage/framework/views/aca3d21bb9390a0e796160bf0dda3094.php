            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        <?php $__currentLoopData = $rekrutmen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($loop->index + 1); ?></td>
                                <td><?php echo e($data->nama); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($data->tanggal_lamaran)->translatedFormat('d F Y')); ?></td>
                                <td>
                                ...
                                <td>
                                    <?php if($data->status_rekrutmen == 1): ?>
                                ...
                                <td>
                                    <form action="<?php echo e(route('rekrutmen.destroy', $data->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <a href="javascript:void(0)" class="btn rounded-pill btn-primary"
                                                data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($data->id); ?>"
                                                style="padding-left: 20px; padding-right: 20px; padding-top: 7px; padding-bottom: 7px">
                                                <i class="bi bi-pencil-square" data-bs-toggle="tooltip"
                                                    data-bs-offset="0,4" data-bs-placement="left" data-bs-html="true"
                                                    title="Edit rekrutmen"></i>
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('rekrutmen.destroy', $data->id)); ?>"
                            ...
                            <div class="modal fade" id="editModal<?php echo e($data->id); ?>" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="modal-dialog modal-md modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo e(route('rekrutmen.update', $data->id)); ?>" method="POST"
                                            ...
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    ...
                                                    <select name="status_rekrutmen" class="form-control">
                                                        ...
                                                        <option value="1"
                                                            <?php echo e($data->status_rekrutmen == 1 ? 'selected' : ''); ?>>
                                                            Diterima
                                                        </option>
                                                        <option value="0"
                                                            <?php echo e($data->status_rekrutmen == 0 ? 'selected' : ''); ?>>
                                                            Menunggu
                                                        </option>
                                                    </select>
                                                </div>
                            ...
                            <div class="modal fade" id="viewCVModal<?php echo e($data->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Lihat CV - <?php echo e($data->nama); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="embed-responsive" style="height: 500px;">
                                                <embed src="<?php echo e(Storage::url($data->cv)); ?>" type="application/pdf"
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('rekrutmen.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row mt-3">
                            <div class="col mb-0 ">
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\admin\rekrutmen\index.blade.php ENDPATH**/ ?>