                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h3 class="stats-number mb-0"><?php echo e($karyawanTerlambat ?? 0); ?></h3>
                ...
                <div class="card stats-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h3 class="stats-number mb-0"><?php echo e($karyawanSakit ?? 0); ?></h3>
                ...
                <div class="card stats-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h3 class="stats-number mb-0" style="font-size: 1.2rem;"><?php echo e(Auth::user()->cabang->nama_cabang ?? 'Belum ditentukan'); ?></h3>
                ...
                <div class="card welcome-card h-100">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h5 class="opacity-8"><?php echo e(Auth::user()->nama_pegawai); ?></h5>
                        </div>
                        ...
                        <div class="info-list">
                            <div class="info-item d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="info-text-value mb-0"><?php echo e(Auth::user()->cabang->nama_cabang ?? 'Belum ditentukan'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="info-item d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="info-text-value mb-0"><?php echo e(Auth::user()->tanggal_masuk ?? 'Belum diatur'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\user\dashboard\index.blade.php ENDPATH**/ ?>