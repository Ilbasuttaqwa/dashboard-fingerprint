            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="<?php echo e(route('welcome.calendar')); ?>">
                            <div class="row g-3">
                                <div class="col-md-4">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function loadAttendanceData() {
            const month = $('#monthFilter').val() || <?php echo e(date('n')); ?>;
            const year = $('#yearFilter').val() || <?php echo e(date('Y')); ?>;
            ...
            $.ajax({
                url: '<?php echo e(route("welcome.calendar.data")); ?>',
                method: 'GET',
                data: {
                    month: month,
                    year: year
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\user\absensi\calendar.blade.php ENDPATH**/ ?>