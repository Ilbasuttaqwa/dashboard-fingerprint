...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    value="<?php echo e(old('nama_pegawai')); ?>" required />
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="id_cabang" id="id_cabang" class="form-control <?php $__errorArgs = ['id_cabang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="<?php echo e($data->id); ?>" <?php echo e(old('id_cabang') == $data->id ? 'selected' : ''); ?>><?php echo e($data->nama_cabang); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="id_jabatan" id="id_jabatan" class="form-control <?php $__errorArgs = ['id_jabatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $jabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>" <?php echo e(old('id_jabatan') == $data->id ? 'selected' : ''); ?>><?php echo e($data->nama_jabatan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="email"
                                    placeholder="Masukan Email" name="email" value="<?php echo e(old('email')); ?>" required />
                            </div>
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" rows="3" 
                                placeholder="Masukan Alamat Lengkap" required><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <input type="text" class="form-control <?php $__errorArgs = ['device_user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\admin\pegawai\create.blade.php ENDPATH**/ ?>