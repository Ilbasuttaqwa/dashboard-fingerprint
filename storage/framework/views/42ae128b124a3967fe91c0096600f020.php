...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?php echo e(route('user.dashboard')); ?>">
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main" style="min-height: 100%;">
        <ul class="navbar-nav">
            <!-- Dashboard Menu -->
            <li class="nav-item <?php echo e(request()->is('user/dashboard') ? 'active' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(request()->is('absensi-kalender') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('welcome.calendar')); ?>">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Bon Menu -->
            <li class="nav-item <?php echo e(request()->is('user/bon*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('user.bon.index')); ?>">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Sakit/Izin Menu -->
            <li class="nav-item <?php echo e(request()->is('user/sakit-izin*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('user.sakit-izin.index')); ?>">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Data Karyawan Menu -->
            <li class="nav-item <?php echo e(request()->is('user/karyawan*') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('user.karyawan.index')); ?>">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
...
<?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\include\user\sidebar.blade.php ENDPATH**/ ?>