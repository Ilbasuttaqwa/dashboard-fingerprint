                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group employee-search-container">
                                    ...
                                    <input type="hidden" name="pegawai_id" id="pegawai_id" value="<?php echo e(old('pegawai_id')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              placeholder="Masukkan keterangan bon" required><?php echo e(old('keterangan')); ?></textarea>
...
<?php echo $__env->make('layouts.user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\user\bon\create.blade.php ENDPATH**/ ?>