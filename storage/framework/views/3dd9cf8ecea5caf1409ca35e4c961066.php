                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($role->nama_jabatan); ?></td>
                                    <td><?php echo e(number_format($role->gaji, 0, ',', '.')); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('role.edit', $role->id)); ?>">
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-fingerprint\resources\views\admin\role\index.blade.php ENDPATH**/ ?>